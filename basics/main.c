...
int main()
{
    ...
    unsigned int r1[] = {0, 1, 0, 0, 1, 0};
    unsigned int r2[] = {1, 0, 1, 0, 1, 0};
    unsigned int r3[] = {0, 1, 0, 1, 0,0};
    unsigned int r4[] = {0,0,1,0,1,1};
    unsigned int r5[] = {1, 1,0,1,0,0};
    unsigned int r6[] = {0, 0, 0, 1, 0, 0};

    const unsigned int *adjmat[] = {r1, r2, r3, r4, r5, r6};
    unsigned int *max_clique;
